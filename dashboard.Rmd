...
### order dow vs. order time of the day for reordered
...
### Scatter Plot with color based on order_hour_of_day
...
line_chart <- sample_data |>
  ...
  plot_ly(
    ...
    type = "scatter", 
    mode = "markers",
    line = list(shape = "spline")  # Optional: This makes the lines curved instead of straight
  )
